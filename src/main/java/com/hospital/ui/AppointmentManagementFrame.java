...
public class AppointmentManagementFrame extends JFrame {
        ...
        SwingUtilities.invokeLater(() -> {
            try {
                ...
                for (Appointment appointment : appointments) {
                    ...
                    String dSpec = (d != null) ? d.getSpecialization().toString() : "Unknown";
        ...
        SwingUtilities.invokeLater(() -> {
            try {
                ...
                for (Appointment appointment : allAppointments) {
                    ...
                    String dSpec = (d != null) ? d.getSpecialization().toString() : "";

                    if (pName.toLowerCase().contains(searchTerm) ||
                            dName.toLowerCase().contains(searchTerm) ||
                            dSpec.toLowerCase().contains(searchTerm)) {
    ...
    private void filterAppointments() {
        ...
        SwingUtilities.invokeLater(() -> {
            try {
                ...
                for (Appointment appointment : allAppointments) {
                    if (appointment.getStatus().name().equalsIgnoreCase(selectedStatus.replace(" ", "_"))) {
    ...
    private void openEditAppointmentDialog() {
        ...
        try {
            ...
            if (appointment != null) {
                AppointmentDialog dialog = new AppointmentDialog(this, "Edit Appointment", appointment, patients,
                        doctors);
                dialog.setVisible(true);
